...
|    7 | GROUP       | CURRENT  | NO                   | ABORT  | DROP ❌<br />CLEAR ❌<br />COMPLETE RECOVER ❌<br />INCOMPLETE RECOVER ✅<br />(until cancel) |
|    8 | EVERY GROUP | ALL      | YES                  | OPEN   | DROP ❌<br />CLEAR ✅                                          |
|    9 | GROUP       | CURRENT  | ALMOST               | ABORT  | COMPLETE RECOVER ❌<br />INCOMPLETE RECOVER ✅<br />(until time) |
