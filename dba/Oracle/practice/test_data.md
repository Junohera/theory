...
(profno number(4) primary key,
 ...
 deptno  number(3),
 email  varchar2(55),
 hpage  varchar2(55)) tablespace users;
...
insert into member
 values (1001,'서진수','7510231234567','a1234','simson','아내이름?','김희연') ;

insert into member
 values(1002,'김희연','7509222345678','b1234','bobby','남편이름?','서진수') ;

insert into member
 values (1003,'서채원','1410234567890','c1234','daddy','아빠이름?','서진수');

insert into member
 values (1004,'서채돌','1609223456789','d1234','mommy','엄마이름?','김희연') ;
...
insert into reg_test2 values (2,'10.10.10.1');
insert into reg_test2 values (3,'172.16.5.100');
insert into reg_test2 values (4,'172.16.168.2');
insert into reg_test2 values (5,'172.61.186.2');
insert into reg_test2 values (6,'255.255.255.0');
