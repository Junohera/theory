...
sqlldr scott/oracle control=emp_point9.ctl
...
# 매시간 아래 양식으로 데이터가 생성된다고 가정
# 이 데이터들을 모두 특정 테이블에 로딩

# FILE_FULL_NAME
# emp_point${RANDOM}.csv
...
# ENVIRONMENT
# 1. mkdir -p /home/oracle/batch/$(date +%Y%m%d_%H)
# 2. vi generate_data.sh
#  #!/bin/sh
#
#  for i in $(seq 1 100)
#  do
...
load data
characterset utf8
infile '/home/oracle/batch/$1.csv'
append
into table batch_loading_data
fields terminated by ','
...
func_execute_ctl() {
sqlldr scott/oracle control="$1.ctl"
}
